<div class="mt-5 w-4/12 -mx-8 lg:block">
    <div class="px-8">
        <h1 class="mb-4 text-xl font-bold text-gray-700">Authors</h1>
        <div class="flex flex-col max-w-sm px-6 py-4 mx-auto bg-white rounded-lg shadow-md mt-5">
            <ul class="-mx-4">
    ...
    <div class="px-8 mt-10">
        <h1 class="mb-4 text-xl font-bold text-gray-700 mt-4">Categories</h1>
        <div class="flex flex-col max-w-sm px-4 py-6 mx-auto bg-white rounded-lg shadow-md">
            <ul class="container">
                <li><a href="#" class="mx-1 font-bold text-gray-700 hover:text-gray-600  ">-
                        AWS</a></li>
                <li class="mt-2"><a href="#" class="mx-1 font-bold text-gray-700 hover:text-gray-600  ">-
                        Laravel</a></li>
                <li class="mt-2"><a href="#" class="mx-1 font-bold text-gray-700 hover:text-gray-600 ">-
                        Vue</a>
                </li>
                ...
                <li class="flex items-center mt-2"><a href="#"
                        class="mx-1 font-bold text-gray-700 hover:text-gray-600 ">-
                        Django</a></li>
                <li class="flex items-center mt-2"><a href="#"
                        class="mx-1 font-bold text-gray-700 hover:text-gray-600 ">-
                        PHP</a>
    ...
    <div class="px-8 mt-10">
        <h1 class="mb-4 text-xl font-bold text-gray-700 mt-4">Recent Post</h1>
        <div class="flex flex-col max-w-sm px-8 py-6 mx-auto bg-white rounded-lg shadow-md container">
